...
def create_app(config_class=None):
    ...
    # from photovault.routes.photo_detection import photo_detection_bp  # DISABLED - OpenCV removed
    ...
    # app.register_blueprint(photo_detection_bp)  # DISABLED - OpenCV removed
